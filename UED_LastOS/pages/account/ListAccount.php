...
<body>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="nav-item"><a class="nav-link" href="">
							<?php include "../../config/pages/account/delete.php";
							?>
						</a></li>
	...
	<div class="jumbotron text-center">
		...
		<?php include "../../config/pages/account/search.php"; ?>
	...
	<div class="row bg-img">
		<div class="container">
			...
			<div class="container text-left">
				<a href="../../pages/account/CreateAccount.php" class="btn btn-success">Add
					New</a>
			</div>
			<br>
					...
					<?php while ($row = mysqli_fetch_assoc($result)) : ?>
						...
						<tr>
							...
							<td class="text-center">
								...
								<?php if ($row['isAdmin'] == true) echo '<i class="fa fa-check"></i> ' ?>

								<?php if ($row['isAdmin'] == false) echo '<i class="fa fa-ban"></i> ' ?>

							</td>
							<td class="text-center">

								<?php if ($row['isEmployee'] == true) echo '<i class="fa fa-check"></i> ' ?>

								<?php if ($row['isEmployee'] == false) echo '<i class="fa fa-ban"></i> ' ?>

							</td>
							<td class="text-center">

								<?php if ($row['isAdmin'] == false || $row['isEmployee'] == true) { ?>
									<a href="EditAccount.php?id=<?= $row['id'] ?>"><i class="fas fa-edit"></i></a>
									&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<script>
		function showMess($id) {
			...
			if (option === true) {
				window.location.href = '../../config/pages/account/delete.php?id=' + $id;
			}
