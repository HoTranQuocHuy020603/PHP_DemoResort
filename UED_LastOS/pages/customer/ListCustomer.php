...
<body>
	...
	<div class="jumbotron text-center">
		...
		<?php include "../../config/pages/customer/search.php"; ?>
	...
	<div class="row">
		<div class="container bg-img">
			<h3 class="text-center h3">List of Customer</h3>
			<hr>
			<?php if ($_SESSION['isAdmin'] == 1 || $_SESSION['isEmployee'] == 1) { ?>
				<div class="container text-left">
					<a href="../../pages/customer/CreateCustomer.php" class="btn btn-success">Add
						New</a>
				</div>
				<?php  }?>
			<br>
				...
				<?php while ($row = mysqli_fetch_assoc($result)) : ?>
						...
						<tr>
							...
							<?php if ($_SESSION['isAdmin'] == 1 || $_SESSION['isEmployee'] == 1) { ?>
								...
								<td class="text-center"><a href="EditCustomer.php?id=<?= $row['id'] ?>"><i class="fas fa-edit"></i></a>
	...
	<script>
		function showMess($id) {
			var option = confirm('Are you sure to delete this customer!!!');
			if (option === true) {
				window.location.href = '../../config/pages/customer/delete.php?id=' + $id;
			}
