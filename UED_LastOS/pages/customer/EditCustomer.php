	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<?php include "../../config/pages/customer/edit.php" ; ?>
				</a></li>
			...
			<div class="row2">
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="email" name="email" id="email" placeholder="Enter your email" value="<?=$row['email']?>" class="form-control" required="required">
						</div>
					</div>
				</div>
				<!-----For Phone Number---->
